...
# simple one liner for command line copying (Windows-specific)

set DATA_DIR=${PWD}/Data
docker run -d --rm -p 28787:8787 --name hello-world2 -e USERID=$UID -e PASSWORD=SoSecret! -v ${DATA_DIR}:/home/rstudio/Data rstudio/hello-world
